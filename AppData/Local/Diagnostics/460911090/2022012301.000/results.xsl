...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ms="urn:microsoft-performance" exclude-result-prefixes="msxsl" version="1.0">
	...
	<xsl:variable name="images">
		...
		<!-- root cause states -->
		<String id="fixed">Corregido</String>
		<String id="notfixed">No corregido</String>
...
function key_folder(d, state)
{
  if (window.event.keyCode == 13) {
    ...
    event.returnValue = false;
						...
						<div class="page">
							<xsl:variable name="strings">
								<String id="Found">Problemas encontrados</String>
								<String id="Checked">Posibles problemas que se comprobaron</String>
								<String id="Publisher">Detalles del publicador</String>
								<String id="Detection">Detalles de detección</String>
	...
	<xsl:template name="RootCauseStatus">
		<xsl:variable name="strings">
			<String id="Fixed">Corregido</String>
			<String id="Not Detected">Problema no encontrado</String>
			<String id="Not Fixed">No corregido</String>
			<String id="Detected">Detectado</String>
		</xsl:variable>
		<div>
			<xsl:if test="Data[@id='Status'] = 'Not Detected'">
	...
	<xsl:template name="RootCauseEmpty">
		<xsl:variable name="strings">
			<String id="Empty">Ningún problema detectado</String>
		</xsl:variable>
	...
	<xsl:template name="ResolutionStatus">
		<xsl:variable name="strings">
			<String id="Not Run">Sin ejecutar</String>
			<String id="Succeeded">Completado</String>
			<String id="Failed">Incorrecto</String>
	...
	<xsl:template name="ScriptStatus">
		<xsl:variable name="strings">
			<String id="Succeeded">Correcto</String>
			<String id="Failed">Incorrecto</String>
		</xsl:variable>
		<xsl:choose>
	...
	<xsl:template match="InputArguments[Data]|OutputArguments[Data[@id !='Result']]">
		<xsl:variable name="strings">
			...
			<String id="OutputArguments">Argumentos de salida</String>
		</xsl:variable>
	...
	<xsl:template match="Object[@Type='System.Diagnostics.Eventing.Reader.EventLogRecord']">
		<xsl:variable name="strings">
			<String id="LevelDisplayName">Nivel</String>
			<String id="LogName">Registro</String>
			<String id="TimeCreated">Fecha</String>
	...
	<xsl:template match="ComputerInformation">
		<xsl:variable name="strings">
			<String id="Computer">Nombre del equipo</String>
			<String id="Collection">Información recopilada</String>
		</xsl:variable>
